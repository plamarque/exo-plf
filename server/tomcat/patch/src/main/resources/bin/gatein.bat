...
set EXO_CLOUD_OPTS=-javaagent:..\lib\cloud-instrument-1.0-Alpha09-SNAPSHOT.jar=..\gatein\conf\cloud\agent-configuration.xml -Dtenant.masterhost=localhost -Dtenant.repository.name=repository -Dtenant.jcr.data.dir=../gatein/data/jcr
