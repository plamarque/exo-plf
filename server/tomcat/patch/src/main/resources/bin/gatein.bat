...
set EXO_CLOUD_ADMIN_OPTS=-Dcloud.admin.log.dir=../logs/cloud-admin -Dcloud.admin.data.dir=../data -Dcloud.admin.configuration.dir=../gatein/conf/exo-admin-conf -Dcloud.admin.configuration.file=../gatein/conf/exo-admin-conf/admin.properties
